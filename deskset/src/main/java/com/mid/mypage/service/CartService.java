...
public abstract class CartService {
    ...
    public abstract int increaseCartQuantity(String memNo, String productNo, int quantity);
    public abstract int addToCart(String memNo, String productNo, int quantity);
}
