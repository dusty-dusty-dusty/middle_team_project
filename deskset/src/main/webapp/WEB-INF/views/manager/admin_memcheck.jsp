...
<main class="flex-1 p-8 overflow-auto">
	<div class="max-w-7xl mx-auto">
		<!-- 헤더 -->
		<header class="mb-8">
			<h1 class="text-2xl font-bold text-gray-800 mb-2">회원정보 확인</h1>
			...
			<form class="space-y-6">
				<div class="grid grid-cols-1 gap-6 md:grid-cols-3">
					...
					<div class="col-span-1">
						<label class="block font-medium text-gray-700 mb-2">회원명</label>
					</div>
					<div class="col-span-2">
						<input type="text" placeholder="관리자명을 입력하세요" disabled
					...
					<!-- 회원 ID -->
					<div class="col-span-1">
						<label class="block font-medium text-gray-700 mb-2">회원 ID</label>
					</div>
					...
					<!-- 이메일 -->
					<div class="col-span-1">
						<label class="block font-medium text-gray-700 mb-2">회원 이메일</label>
					</div>
					<div class="col-span-2">
					...
					<div class="col-span-2">
						<input type="tel" placeholder="전화번호를 입력하세요" disabled
							class="w-full border border-gray-300 rounded-button py-2 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary">
					</div>
				
					<!-- 주소 -->
					<div class="col-span-1">
						<label class="block font-medium text-gray-700 mb-2">주소</label>
					</div>
					<div class="col-span-2">
						<input type="text" placeholder="ㅇ잉싱ㄴㅇㄻㅇ궁ㅇㅇ동ㅇㅇㅇ아파트" disabled
							class="w-full border border-gray-300 rounded-button py-2 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary">
					</div>
				
					<!-- 휴면 회원 여부 -->
					<div class="col-span-1">
						<label class="block font-medium text-gray-700 mb-2">휴면 회원 여부</label>
					</div>
					<div class="col-span-2">
						<select class="w-40 border border-gray-300 rounded-button py-2 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary">
							<option value="Y" selected>일반</option>
				...
				<div class="flex justify-end mt-8 pt-4 border-t border-gray-200">
					<button type="button"
						class="memcheck_cancel mr-2 bg-gray-200 text-gray-700 py-2 px-6 rounded-button hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
						확인
					</button>
					<button type="submit"
