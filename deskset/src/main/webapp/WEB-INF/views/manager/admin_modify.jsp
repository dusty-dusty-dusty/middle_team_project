...
<main class="flex-1 p-8 overflow-auto">
	<div class="max-w-7xl mx-auto">
		<!-- 헤더 -->
		<header class="mb-8">
			<h1 class="text-2xl font-bold text-gray-800 mb-2">관리자 수정</h1>
		...
		<section class="bg-white rounded shadow-sm p-6">
			<form class="space-y-6">
				...
				<div class="flex justify-end mt-8 pt-4 border-t border-gray-200">
					<a href=''
						class="mr-2 bg-[#f55742] text-white py-2 px-6 rounded-button hover:bg-[#f29274]/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
						삭제
					</a>
					<button type="button"
						class="admin_modify_cancel mr-2 bg-gray-200 text-gray-700 py-2 px-6 rounded-button hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
						취소
					</button>
					<button type="submit"
